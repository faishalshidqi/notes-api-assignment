...
import {deleteNote, getActiveNotes} from '../utils/data.ts'
import SearchBar from '../components/SearchBar.tsx'
import {LocaleConsumer} from '../contexts/LocaleContext.ts'
import Loading from '../components/Loading.tsx'

export default class HomePage extends Component<unknown, { notes: { id: string, title: string, body: string, created_at: string}[], keyword: string, loading: boolean }> {
